      ...
      <div class="row">
        ...
        <div class="col-lg-5">
          ...
          @if(Cart::instance('cart')->content()->where('id', $product->id)->count()>0)
            <a href="{{ route('cart.index') }}" class="btn btn-warning mb-3">Ir para o Carrinho</a>
          @else
          <form name="addtocart-form" method="post" action="{{ route('cart.add') }}">
            ...
            <div class="product-single__addtocart">
              ...
              <button type="submit" class="btn btn-primary btn-addtocart" data-aside="cartDrawer">Adicionar ao carrinho</button>
            </div>
          </form>
          @endif
            ...
            @foreach ($rproducts as $rproduct)
                <div class="swiper-slide product-card">
                    <div class="pc__img-wrapper">
                        <a href="{{ route('shop.product.show', ['product_slug' => $rproduct->slug]) }}">
                        ...
                        {{-- <button class="pc__atc btn anim_appear-bottom btn position-absolute border-0 text-uppercase fw-medium js-add-cart js-open-aside" data-aside="cartDrawer" title="Add To Cart">Adicionar ao carrinho</button> --}}
                    </div>
