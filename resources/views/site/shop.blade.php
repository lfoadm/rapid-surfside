            ...
            <div class="accordion" id="size-filters">
                <div class="accordion-item mb-4 pb-3">
                    ...
                    <div id="accordion-filter-size" class="accordion-collapse collapse show border-0" aria-labelledby="accordion-heading-size" data-bs-parent="#size-filters">
                        <div class="accordion-body px-0 pb-0">
                            <div class="d-flex flex-wrap">
                                <a href="#" class="swatch-size btn btn-sm btn-outline-light mb-3 me-3 js-filter">PP</a>
                                <a href="#" class="swatch-size btn btn-sm btn-outline-light mb-3 me-3 js-filter">P</a>
                                <a href="#" class="swatch-size btn btn-sm btn-outline-light mb-3 me-3 js-filter">M</a>
                                <a href="#" class="swatch-size btn btn-sm btn-outline-light mb-3 me-3 js-filter">G</a>
                                <a href="#" class="swatch-size btn btn-sm btn-outline-light mb-3 me-3 js-filter">GG</a>
                                <a href="#" class="swatch-size btn btn-sm btn-outline-light mb-3 me-3 js-filter">XGG</a>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="accordion" id="price-filters">
                <div class="accordion-item mb-4">
                    ...
                    <div id="accordion-filter-price" class="accordion-collapse collapse show border-0" aria-labelledby="accordion-heading-price" data-bs-parent="#price-filters">
                        <input class="price-range-slider" type="text" name="price_range" value="" data-slider-min="1" data-slider-max="500" data-slider-step="5" data-slider-value="[{{ $min_price }}, {{ $max_price }}]" data-currency="R$ " />
                        <div class="price-range__info d-flex align-items-center mt-2">
                            <div class="me-auto">
                                <span class="text-secondary">Preço mínimo: </span>
                                <span class="price-range__min">R$ 1,00</span>
                            </div>
                            <div>
                                <span class="text-secondary">Preço máximo: </span>
                                <span class="price-range__max">R$ 500,00</span>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="shop-list flex-grow-1">
            ...
            <div class="d-flex justify-content-between mb-4 pb-md-2">
                <div class="breadcrumb mb-0 d-none d-md-block flex-grow-1">
                    ...
                    <a href="#" class="menu-link menu-link_us-s text-uppercase fw-medium">Compras</a>
                </div>
                ...
                <div class="shop-acs d-flex align-items-center justify-content-between justify-content-md-end flex-grow-1">
                    ...
                    <select class="shop-acs__select form-select w-auto border-0 py-0 order-1 order-md-0" aria-label="Sort Items" name="orderby" id="orderby">
                        <option value="-1" {{ $order == -1 ? 'selected':'' }}>Relevante</option>
                        <option value="1" {{ $order == 1 ? 'selected':'' }}>Novidades</option>
                        <option value="2" {{ $order == 2 ? 'selected':'' }}>Antigos</option>
                        <option value="3" {{ $order == 3 ? 'selected':'' }}>Menor preço</option>
                        <option value="4" {{ $order == 4 ? 'selected':'' }}>Maior preço</option>
                    </select>
                    ...
                    <div class="product-card mb-3 mb-md-4 mb-xxl-5">
                        <div class="pc__img-wrapper">
                            <div class="swiper-container background-img js-swiper-slider"
                                ...
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                        <a href="{{ route('shop.product.show', ['product_slug' => $product->slug]) }}"><img loading="lazy" src="{{ asset('uploads/products') }}/{{ $product->image }}" width="330" height="400" alt="{{ $product->name }}" class="pc__img"></a>
                                    </div>
                                    <div class="swiper-slide">
                                        @foreach (explode(",", $product->images) as $gimg)
                                            <a href="{{ route('shop.product.show', ['product_slug' => $product->slug]) }}"><img loading="lazy" src="{{ asset('uploads/producs') }}/{{ $gimg }}" width="330" height="400" alt="{{ $product->name }}" class="pc__img"></a>
                                        @endforeach
                                    </div>
                                </div>
                            ...
                            @else
                                <form name="addtocart-form" method="post" action="{{ route('cart.add') }}">
                                    ...
                                    <button type="submit" class="pc__atc btn anim_appear-bottom btn position-absolute border-0 text-uppercase fw-medium" data-aside="cartDrawer" title="Add To Cart">Adicionar ao carrinho</button>
                                </form>
                            @endif
                        </div>
                        ...
                        <div class="pc__info position-relative">
                            ...
                            <h6 class="pc__title"><a href="{{ route('shop.product.show', ['product_slug' => $product->slug]) }}">{{ $product->name }}</a></h6>
                            <div class="product-card__price d-flex">
                                <span class="money price">
                                    @if($product->sale_price)
                                        <s>R${{ $product->regular_price }}<space></s> R${{ $product->sale_price }}
                                    @else
