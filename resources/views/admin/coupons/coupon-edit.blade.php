...
<div class="main-content-inner">
    <div class="main-content-wrap">
        <div class="flex items-center flex-wrap justify-between gap20 mb-27">
            <h3>Editando o cupon de código: <strong>{{ $coupon->code }}</strong></h3>
            <ul class="breadcrumbs flex items-center flex-wrap justify-start gap10">
                ...
                <li>
                    <div class="text-tiny">Editar Cupom</div>
                </li>
            </ul>
        </div>
        <div class="wg-box">
            <form class="form-new-product form-style-1" method="POST" action="{{ route('admin.coupon.update') }}">
                ...
                <fieldset class="name">
                    ...
                    <input class="flex-grow" type="text" placeholder="Código do cupom" name="code" tabindex="0" value="{{ $coupon->code }}" aria-required="true" required="">
                </fieldset>
                ...
                <fieldset class="name">
                    ...
                    <input class="flex-grow" type="text" placeholder="Valor do cupom" name="value" tabindex="0" value="{{ $coupon->value }}" aria-required="true" required="">
                </fieldset>
                ...
                <fieldset class="name">
                    ...
                    <input class="flex-grow" type="text" placeholder="Valor do carrinho" name="cart_value" tabindex="0" value="{{ $coupon->cart_value }}" aria-required="true" required="">
                </fieldset>
                ...
                <fieldset class="name">
                    ...
                    <input class="flex-grow" type="date" placeholder="Validade cupom" name="expiry_date" tabindex="0" value="{{ $coupon->expiry_date }}" aria-required="true" required="">
                </fieldset>
                @error('expiry_date') <span class="alert alert-danger text-center">{{ $message }}</span> @enderror

                <div class="bot">
                    <div></div>
                    <button class="tf-button w208" type="submit">Atualizar</button>
                </div>
            </form>
        </div>
    </div>
